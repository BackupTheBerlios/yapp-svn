/**
  ...
  dataevent.cpp - Copyright enrique
 ...
 * 
 */
dataEntity dataEvent::get_evDEntity ( ) {
  
}
/**
 * 
 */
void dataEvent::set_evDEntity (dataEntity value ) {
  
}
/**
 * 
 */
dataTick dataEvent::get_data ( ) {
  
}
/**
 * 
 */
void dataEvent::set_data (dataTick value ) {
